                    ...
                    <div class="card-header bg-warning text-dark">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Edit data siswa {{ $siswa->nama }}</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('siswa.update', $siswa) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="jenis_kelamin"
                                                       id="laki" value="L" {{ old('jenis_kelamin', $siswa->jenis_kelamin) == 'L' ? 'checked' : '' }} required>
                                        ...
                                        <div class="col-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="jenis_kelamin"
                                                       id="perempuan" value="P" {{ old('jenis_kelamin', $siswa->jenis_kelamin) == 'P' ? 'checked' : '' }} required>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kabupaten') is-invalid @enderror"
                                           id="kabupaten" name="kabupaten" value="{{ old('kabupaten', $siswa->kabupaten) }}" required>
                                    @error('kabupaten')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                @if($siswa->foto)
                                    <div class="mt-2">
                                        <img src="{{ asset($siswa->foto) }}" alt="Foto Siswa" class="img-thumbnail" style="width: 100px; height: 100px; object-fit: cover;">
